...
class _DetailpageState extends State<Detailpage> {
  ...
  imageUrl = WeatherStateName.replaceAll('', '_').toLowerCase();
                    ...
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(widget.consolidatedWeatherList[index]['the_temp'].round().toString()+'C',
                          style: TextStyle(
                            fontSize: 17,
                          ...
                          // ignore: prefer_interpolation_to_compose_strings
                          Image.asset('assets/$imageUrl.png',width: 40,),
                         Text( newDate,
                          style: TextStyle(
                            fontSize: 17,
                            color: index == selectedIndex? Colors.blue:Colors.white,
                        ...
                        Positioned(
                          ...
                          Positioned(
                            ...
                            child: Padding(
                              ...
                              child: Text(WeatherStateName,style: TextStyle(
                                color: Colors.white,
                                fontSize: 20,
                              ...
                              left: 20,
                               child: Container(
                                ...
                                child: Row(
                                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
        weatherItem(text: "windspeed",value: 
        widget.consolidatedWeatherList[selectedIndex]['wind_speed'].round(), Unit: 'km/hr', ImageUrl: 'assets/Windspeed.png',),
         weatherItem(text: "windspeed",value: 
         widget.consolidatedWeatherList[selectedIndex]['humidity'].round(), Unit: '%x', ImageUrl: 'assets/humidity.png',),
         weatherItem(text: "windspeed",value: 
         widget.consolidatedWeatherList[selectedIndex]['max_temp'].round(), Unit: 'km/hr', ImageUrl: 'assets/Maximum Temperature.png',),
                               ...
                               Positioned(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                   Text( widget.consolidatedWeatherList[selectedIndex]['the_temp'].round().toString(),
                                     style: TextStyle(
                                      fontSize: 80,
                    ...
                    return Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              currentDate, style: const TextStyle(
                            ...
                            Row(
                              children: [
                                Text(
                                  widget.consolidatedWeatherList[index]['max_temp'].round().toString(), style: const TextStyle(
                                    color: Colors.grey,
                                    fontSize: 30,
                                ...
                                Text(
                                  widget.consolidatedWeatherList[index]['min_temp'].round().toString(), style: const TextStyle(
                                    color: Colors.grey,
                                    fontSize: 25,
